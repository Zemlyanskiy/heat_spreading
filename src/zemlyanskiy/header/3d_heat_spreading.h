...
static inline void Output(char *DATA, char *mode, double *arr, int length)
{
...
static inline double *MultiCSR(double *arr, double *csr_values, int *first_line, int *columns, struct input_data temp)
{
  double *composition = (double *)calloc(temp.array.Lx * temp.array.Ly * temp.array.Lz, sizeof(double));
#pragma omp parallel for
  for (int i = 0; i < temp.array.Lx * temp.array.Ly * temp.array.Lz; i++)
  {
